...
openvpn --remote $1 --port 1985 --dev tap2 --ifconfig 245.2.18.82 255.255.255.0 10.51.111.130 &
openvpn --remote $1 --port 1986 --dev tap3 --ifconfig 245.2.18.82 255.255.255.0 10.51.111.130 &
